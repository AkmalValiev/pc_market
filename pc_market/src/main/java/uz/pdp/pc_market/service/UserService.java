...
import uz.pdp.pc_market.payload.UserDto;
import uz.pdp.pc_market.repository.UserRepository;
import uz.pdp.pc_market.repository.WarehouseRepository;
...
public class UserService {
    ...
    public ApiResponse addUser(UserDto userDto){
        ...
        if (exists)
            return new ApiResponse("Kiritilgan phone numberli user mavjud!", false);
